...
Route::group(['prefix' => 'storage', 'middleware' => ['isStorage', 'auth']], function () {
    Route::get('home/{id = 0}', [StorageController::class, 'index'])->name('storage.home');
...
Route::group(['prefix' => 'accountant', 'middleware' => ['isAccountant', 'auth']], function () {
    ...
    Route::get('allschotfaktur/{id}/{start}/{end}/{costid}', [AccountantController::class, 'allschotfaktur'])->name('accountant.allschotfaktur');
