    ...
    $(document).ready(function() {
        $('#showreport').click(function(){
            ...
            if(beginid == 0 || endid == 0 || beginid > endid){
                ...
                $.ajax({
                    method: "GET",
                    url: '/boss/selectreport/0/'+0+'/'+beginid+'/'+endid,
                ...
                $.ajax({
                    method: "GET",
                    url: '/boss/selectreport/1/'+costid+'/'+beginid+'/'+endid,
                    success: function(data) {
                        table.html(data);
                    }
                });
                ...
                $.ajax({
                    method: "GET",
                    url: '/boss/selectreport/2/'+allcostid+'/'+beginid+'/'+endid,
                    success: function(data) {
                        table.html(data);
                    }
                });
