<div class="list-group list-group-flush my-3">
    ...
    <a href="/storage/addedproducts/0/0" class="list-group-item list-group-item-action bg-transparent second-text fw-bold {{Request::is('storage/addedproducts/0/0') ? 'active' : null }}"><i class="fas fa-plus"></i> Maxsulot qo'shish</a>
    ...
    <!-- <a href="/storage/takecategories" class="list-group-item list-group-item-action bg-transparent text-danger fw-bold"><i class="fas fa-power-off me-2"></i>Logout</a> -->
</div>
