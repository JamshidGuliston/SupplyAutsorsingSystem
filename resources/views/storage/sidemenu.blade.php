<div class="list-group list-group-flush my-3">
    ...
    <a href="/storage/addedproducts" class="list-group-item list-group-item-action bg-transparent second-text fw-bold {{Request::is('storage/addedproducts') ? 'active' : null }}"><i class="fas fa"></i> Checklar</a>
    <a href="/technolog/addmultisklad" class="list-group-item list-group-item-action bg-transparent second-text fw-bold {{Request::is('technolog/addmultisklad') ? 'active' : null }}"><i class="fas fa-comment-dots me-2"></i>Bog'cha sklad</a>
