<div class="list-group list-group-flush my-3">
    <a href="/storage/home/0" class="list-group-item list-group-item-action bg-transparent second-text {{Request::is('storage/home/0') or $id > 0 ? 'active' : null }}"><i class="fas fa-tachometer-alt me-2"></i>Bosh sahifa</a>
