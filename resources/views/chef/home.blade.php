        ...
        <div class="col-md-3">
            <div class="p-3 bg-white shadow-sm align-items-center rounded">
                <!-- <form action="/activsecondmenuPDF/{{ $day->id }}/{{ $kindgarden->id }}" method="get"> -->
                    ...
                    <a href="https://drive.google.com/viewerng/viewer?embedded=true&url=cj56359.tmweb.ru/activsecondmenuPDF/{{ $day->id }}/{{ $kindgarden->id }}" class="btn btn-success" style="width: 100%;" download>Menyu</a>
                <!-- </form> -->
                @if($bool->count() == 0)
