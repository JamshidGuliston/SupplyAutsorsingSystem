...
<body>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Menyu sarlavhasi</h5>
    ...
    <div class="wrapper">
        ...
        <div class="main-container">
            <div class="header">
                <div class="logo">Nishon Invest
                    <span class=logo-det>MCHJ</span>
                </div>
            ...
            <div class="user-box first-box">
                <div class="Timeline" style="--delay: .4s">

                    <svg height="5" width="200">
                        <line x1="50" y1="0" x2="200" y2="0" style="stroke:#004165;stroke-width:5" />
                    ...
                    <div class="event1">
                        ...
                        <div class="event1Bubble">
                            ...
                            <div class="eventTitle">Kecha</div>
                        </div>
                    ...
                    <div class="event2">
                        ...
                        <div class="event2Bubble">
                            ...
                            <div class="eventTitle"><a href="#" style="color: green;">Bugungi menyu</a></div>
                        </div>
                        <div class="event2Author">by Tom Eggleston</div>
                        <svg height="20" width="20">
                            <circle cx="10" cy="11" r="5" fill="#ff0000" />
                        </svg>
                        <div class="time2">Soat 10 : 00 ga qadar ertangi kunga tayyorlaning </div>
                    </div>

                    <svg height="5" width="25">
                        <line x1="0" y1="0" x2="25" y2="0" style="stroke:#004165;stroke-width:5" />
                        Sorry, your browser does not support inline SVG.
                    </svg>
                    ...
                    <div class="event3 futureGray ">
                        <div class="event1Bubble futureOpacity">
                            <div class="eventTime">
                                <div class="DayDigit">03</div>
                                <div class="Day">
                                    Juma
                                    <div class="MonthYear">Dekabr 2021</div>
                                </div>
                            </div>
                            <div class="eventTitle">Ertaga</div>
                        </div>
                        <svg height="20" width="20">
                ...
                <div class="activity card" style="display: none; --delay: .2s">
                ...
                <div class="discount card" style="display: none; --delay: .4s">
                ...
                <div class="cards-wrapper" style="display: none; --delay: .6s">
            ...
            <div class="user-box second-box">
                <div class="cards-wrapper" style="--delay: 1s;">
                    <div class="cards-header" style="background-color: #d7f3ea; border-bottom: solid #141731;">
                        <div class="cards-view">
                            ...
                            Calendar View
                            <span class="today">Ayni vaqtda</span>
                        </div>
                        <div class="cards-header-date">
                            <div class="title">Ertangi kunga tayyorlaning</div>
                        </div>
                    ...
                    <div class="cards card">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                @if($loop->index+1 == $loop->count) @continue
                                @endif
                                @if($garden->kingar_name_id == $gardens[$loop->index+1]->kingar_name_id )
                                <tr>
                                    <td>
                                        {{ $garden->id }}
                                    </td>
                                    <td> {{ $garden->kingar_name }}</td>
                                    <td>{{$garden->age_number}}</td>
                                    <td>{{$gardens[$loop->index+1]->age_number}}</td>
                                    <!-- <td>{{$loop->index}}</td> -->
                                    <td>
                ...
                <div class="card transection" style="--delay: 1.2s">
                    ...
                    <div class="credit-wrapper">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 291.764 291.764" style="background-color:#292c6d">
                    ...
                    <div class="credit-wrapper">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="background-color:#1f2755">
                    ...
                    <div class="credit-wrapper">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 469.351 469.351" style="background-color: #0365b3">
