...
<html>
    ...
    <div class="logo">Nishon Invest
        <span class=logo-det>MCHJ</span></div>
    ...
    <div class="account-wrapper" style="--delay: .8s">
        ...
        <div class="account-name">Farrux</div>
        <div class="account-title">Texnolog</div>
        </div>
