            ...
            <div class="col-md-12">
                <div class="table" id="table_with_data">
					<div class="col-md-3">
						...
						?>
						<center><b>{{ env('COMPANY_NAME') }} томонида Аутсорсинг хизмати кўрсатилаётган {{ $region->region_name }} {{ $kindgar->number_of_org }}-сонли ДМТТнинг <?php echo $days->last()->day_number ?> . <?php printf('%02d', $mth) ?> . <?php printf('%02d', $costs[0]->year_name) ?> йил  {{ $age->age_name }}ли гуруҳи учун НАКАПИТЕЛ</b></center>
					</div>
                </div>
