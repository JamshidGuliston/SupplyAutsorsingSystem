            ...
            <div class="col-md-12">
                ...
                <table style="table-layout: fixed;">
					...
					<tr>
						...
						<td style="font-size: 6px;"><?php printf("%02.2f", $summa) ?></td>
						<td style="font-size: 6px;"><?php printf("%02.2f", $ustsumma) ?></td>
						<td style="font-size: 6px;"><?php printf("%02.2f", $allsumma) ?></td>
						<td style="font-size: 6px;"><?php printf("%02.2f", $ndssumma) ?></td>
						<td style="font-size: 6px;"><?php printf("%02.2f", $jamisumma) ?></td>
					</tr>
                    </tbody>
                </table>
                <div class="row">
