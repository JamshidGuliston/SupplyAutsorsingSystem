            ...
            <div class="col-md-6">
                <div class="table" id="table_with_data">
					<div class="col-md-6">
						...
						<b>{{ "№ ".$document[0]['group_id']." sana: ". $day->day_number."/".$day->month_name."/".$day->year_name }}</b>
                        <i class="fas fa-store-alt" style="color: dodgerblue; font-size: 18px;"> {{ $kind->kingar_name }}</i>
					</div>
                </div>
                <hr>
